function params = load_dataset_osuch_prep_osuch_ref()
    ica_path = '/data/users2/salman/projects/treatment_response/current_py/results/osuchref_gig_ica_prepdata_only/';
    % this is manually generated by resolving the ICA selected subject list and the OSUCH diagnosis spreadsheet
    sub_info_file = '../../current_py/data/all_subjects/label_all.csv';
