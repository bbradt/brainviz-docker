outputDir = '/data/users2/salman/projects/multiclass/SVM_manifold_code/output/SC/op99';%%%%%%%%%
prefix = 'opSC99';%%%%%%%%%
...
perfType = 3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%me
refFiles='/data/users2/salman/projects/multiclass/SVM_manifold_code/script/SC/SC.nii';%%%%%%%%%
