outputDir = '/data/users2/salman/projects/multiclass/SVM_manifold_code/output/AU/op99';%%%%%%%%%
prefix = 'opAU99';%%%%%%%%%
...
perfType = 3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%me
refFiles='/data/users2/salman/projects/multiclass/SVM_manifold_code/script/AU/AU.nii';%%%%%%%%%
