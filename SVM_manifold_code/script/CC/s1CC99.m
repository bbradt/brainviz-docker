outputDir = '/data/users2/salman/projects/multiclass/SVM_manifold_code/output/CC/op99';%%%%%%%%%
prefix = 'opCC99';%%%%%%%%%

functional_main = '/data/analysis/collaboration/NeuroMark/Data/OSUCH/PrepData_backup/ica99/';
...
perfType = 3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%me
refFiles='/data/users2/salman/projects/multiclass/SVM_manifold_code/script/CC/CC.nii';%%%%%%%%%
sourceDir_filePattern_flagLocation{1}='/data/analysis/collaboration/NeuroMark/Data/OSUCH/PrepData_backup/ica99/';
