...
icatb_read_batch_file('/data/users2/salman/projects/multiclass/SVM_manifold_code/script/VI/s1VI12.m');%%%%
icatb_batch_file_run('/data/users2/salman/projects/multiclass/SVM_manifold_code/script/VI/s1VI12.m');%%%%