outputDir = '/data/users2/salman/projects/multiclass/SVM_manifold_code/output/DM/op99';%%%%%%%%%
prefix = 'opDM99';%%%%%%%%%
...
perfType = 3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%me
refFiles='/data/users2/salman/projects/multiclass/SVM_manifold_code/script/DM/DM.nii';%%%%%%%%%
