outputDir = '/data/users2/salman/projects/multiclass/SVM_manifold_code/output/SM/op99';%%%%%%%%%
prefix = 'opSM99';%%%%%%%%%
...
perfType = 3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%me
refFiles='/data/users2/salman/projects/multiclass/SVM_manifold_code/script/SM/SM.nii';%%%%%%%%%
