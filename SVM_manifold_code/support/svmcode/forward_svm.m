function [rate, sigma, gama, c, in_list, model]=forward_svm(com, label, starting_list, indices, kn_i, kn)%���ŵļӽ����ĳɷ�

%���롪��com�����ܡ��ĳɷ֣�label��n-1����ꣻstarting_list:��ʼѡ��ĳɷּ���%
%�������ÿ��out_list�еĳɷֶ�Ӧ�� ��ȷ�ʡ�AUC��sigma��gama��c����ѡ�ɷ֡�������%
